...
export const priceKnown = (product: Product): boolean => Number.isFinite(product.priceUsd) && product.priceUsd > 0 && !product.styleTags.includes("price-not-provided");

export type BudgetSummary = {
  lines: BudgetLine[];
  /** Missing products, tagged unknown prices, and zero placeholders excluded from known totals. */
