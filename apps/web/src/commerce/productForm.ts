...
export function mountProductForm(root: HTMLElement, o: ProductFormOptions): ProductForm {
  ...
  root.innerHTML = `
    <form class="pform" novalidate>
      ...
      <div class="grid2">
        <label class="field">Price (USD)<input type="number" min="0" step="any" class="f-price" data-field="priceUsd" /></label>
      ...
      <div class="actions"><button type="submit" class="find">Add to catalog</button><button type="button" class="ghost cancel">Cancel</button><span class="status"></span></div>
    </form>`;
